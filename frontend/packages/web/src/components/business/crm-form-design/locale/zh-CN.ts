export default {
  ...
  'crmFormDesign.CLUE_TO_OPPORTUNITY': '线索转项目',
  'crmFormDesign.CUSTOMER_TO_OPPORTUNITY': '新建项目',
  ...
  'crmFormDesign.CONTRACT_TO_ORDER': '新建投稿',
  'crmFormDesign.tip.CLUE_TO_CUSTOMER': '线索转换客户时，将线索的表单字段内容填充到客户表单字段',
  'crmFormDesign.tip.CLUE_TO_OPPORTUNITY': '线索转项目时，将线索表单字段填充到项目表单字段',
  'crmFormDesign.tip.CUSTOMER_TO_OPPORTUNITY': '在客户详情创建项目时，将客户表单字段填充到项目表单字段',
  ...
  'crmFormDesign.tip.OPPORTUNITY_TO_RECORD': '在项目模块写跟进记录时，将项目的表单字段内容填充到记录表单字段',
  ...
  'crmFormDesign.tip.CONTRACT_TO_ORDER': '在合同详情创建投稿时，将合同表单字段填充到投稿表单',
