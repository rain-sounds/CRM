export default {
  ...
  'opportunity.source': '项目来源',
  'opportunity.owner': '负责人',
  'opportunity.department': '部门',
  'opportunity.region': '区域',
  'opportunity.disabledContentTip': '禁用后，成员无法查到该项目',
  'opportunity.intendedProducts': '意向期刊',
  'opportunity.belongDays': '归属天数',
  'opportunity.remainingBelong': '剩余归属',
  'opportunity.followUp': '跟进',
  'opportunity.createOpportunity': '新建项目',
  'opportunity.importOpportunity': '导入项目',
  'opportunity.batchDeleteContentTip': '删除后，成员无法查到该项目，请谨慎操作！',
  'opportunity.batchDeleteTitleTip': '确认删除 {number} 个项目吗？',
  ...
  'opportunity.new': '新建项目',
  'opportunity.allOpportunities': '全部项目',
  ...
  'opportunity.quotation.searchPlaceholder': '通过报价名称/项目名称搜索',
