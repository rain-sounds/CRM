export const GetProductFormConfigUrl = '/product/module/form'; // 获取期刊表单配置
export const UpdateProductUrl = '/product/update'; // 更新期刊
export const GetProductListUrl = '/product/page'; // 期刊列表
export const AddProductUrl = '/product/add'; // 添加期刊
export const GetProductUrl = '/product/get'; // 获取期刊详情
export const DeleteProductUrl = '/product/delete'; // 删除期刊
export const BatchDeleteProductUrl = '/product/batch/delete'; // 批量删除期刊
export const BatchUpdateProductUrl = '/product/batch/update'; // 批量更新期刊
export const DragSortProductUrl = '/product/edit/pos'; // 排序拖拽期刊
export const GetProductOptionsUrl = '/product/list/option'; // 获取当前组织下所有的期刊
// 导入
