...
GraphView.events = {
    ...
    [`contextmenu .${Config.prefixCls}-cell [data-magnet]`]: 'onMagnetContextMenu',
    [`mousedown   .${Config.prefixCls}-cell [data-magnet]`]: 'onMagnetMouseDown',
    [`touchstart  .${Config.prefixCls}-cell [data-magnet]`]: 'onMagnetMouseDown',
    [`dragstart   .${Config.prefixCls}-cell image`]: 'onImageDragStart',
    [`mousedown   .${Config.prefixCls}-edge .${Config.prefixCls}-edge-label`]: 'onLabelMouseDown',
    [`touchstart  .${Config.prefixCls}-edge .${Config.prefixCls}-edge-label`]: 'onLabelMouseDown',
};
