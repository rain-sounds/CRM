...
export function hue2rgb(m1, m2, h) {
    if (h < 0) {
        ++h;
    }
    if (h > 1) {
...
export function rgba2hsla(arg0, arg1, arg2, arg3) {
    const r255 = Array.isArray(arg0) ? arg0[0] : arg0;
    const g255 = Array.isArray(arg0) ? arg0[1] : arg1;
    const b255 = Array.isArray(arg0) ? arg0[2] : arg2;
...
export function hsla2rgba(arg0, arg1, arg2, arg3) {
...
export function invert(color, bw) {
