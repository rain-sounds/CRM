...
export class Animation {
    ...
    finish() {
        ...
        const event = new AnimationPlaybackEvent(this, 'finish', this._currentTime, this._timeline.currentTime);
    ...
    cancel() {
        ...
        this._pausedTime = null;
        this._effect.apply(null);
        const event = new AnimationPlaybackEvent(this, 'cancel', this._currentTime, this._timeline.currentTime);
