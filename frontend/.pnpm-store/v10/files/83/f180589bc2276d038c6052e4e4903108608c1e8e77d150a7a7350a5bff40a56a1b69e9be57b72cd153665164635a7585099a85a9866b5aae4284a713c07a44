...
import { portLabelLayoutPresets, portLabelLayoutRegistry, portLayoutPresets, portLayoutRegistry, } from '../registry';
export class PortManager {
    ...
    getPortLabelLayout(port, portPosition, elemBBox) {
        ...
        const layoutFn = portLabelLayoutRegistry.get(name) || portLabelLayoutPresets.left;
        if (layoutFn) {
