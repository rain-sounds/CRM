import { ArrayExt, Dictionary, Dom, FunctionExt, ObjectExt, StringExt, Util, } from '../common';
import { Point } from '../geometry';
import { isValidDefinition, } from '../registry/attr';
...
export class AttrManager {
    ...
    processAttrs(elem, raw) {
        ...
        Object.keys(raw).forEach((name) => {
            ...
            const isValid = FunctionExt.call(isValidDefinition, this.view, definition, val, {
                elem,
                attrs: raw,
                cell: this.cell,
                view: this.view,
