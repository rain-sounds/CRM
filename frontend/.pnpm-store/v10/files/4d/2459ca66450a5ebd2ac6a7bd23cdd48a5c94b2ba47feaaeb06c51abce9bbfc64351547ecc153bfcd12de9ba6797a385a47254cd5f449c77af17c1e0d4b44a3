...
import { Rectangle, snapToGrid, } from '../../geometry';
import { Graph, } from '../../graph';
import { View } from '../../view';
import { content } from './style/raw';
export const DndDefaults = {
    // animation: false,
...
export class Dnd extends View {
    ...
    constructor(options) {
        super();
        this.name = 'dnd';
        this.options = Object.assign(Object.assign({}, DndDefaults), options);
        this.init();
    }
    init() {
    ...
    drop(draggingNode, pos) {
        if (this.isInsideValidArea(pos)) {
            ...
            droppingNode.position(snapToGrid(local.x, gridSize), snapToGrid(local.y, gridSize));
