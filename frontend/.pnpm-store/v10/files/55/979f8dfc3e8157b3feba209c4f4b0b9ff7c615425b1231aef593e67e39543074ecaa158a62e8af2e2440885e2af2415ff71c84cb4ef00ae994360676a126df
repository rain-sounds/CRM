...
export function getMaxDim(nodes, name) {
    return nodes.reduce((memo, node) => Math.max(node === null || node === void 0 ? void 0 : node.getSize()[name], memo), 0);
}
export function getNodesInRow(nodes, rowIndex, columnCount) {
    const res = [];
...
export function getNodesInColumn(nodes, columnIndex, columnCount) {
    const res = [];
...
export function accumulate(items, start) {
