...
class Anchor extends tool_1.ToolItem {
    get type() {
        return this.options.type;
    }
    onRender() {
        common_1.Dom.addClass(this.container, this.prefixClassName(`edge-tool-${this.type}-anchor`));
    ...
    onMouseMove(evt) {
        ...
        if (typeof snapFn === 'function') {
            const tmp = common_1.FunctionExt.call(snapFn, edgeView, coords, terminalView, terminalMagnet, terminalType, edgeView, this);
        ...
        if (typeof anchorFn === 'function') {
            anchor = common_1.FunctionExt.call(anchorFn, edgeView, coords, terminalView, terminalMagnet, terminalType, edgeView, this);
        }
...
Anchor.defaults = Object.assign(Object.assign({}, tool_1.ToolItem.getDefaults()), { tagName: 'g', markup: [
        {
            tagName: 'circle',
            selector: 'anchor',
            attrs: {
        ...
        fill: '#33334F',
        r: 6,
    }, areaPadding: 6, snapRadius: 10, resetAnchor: true, restrictArea: true, removeRedundancies: true, anchor: Util.getAnchor, snap(pos, terminalView, terminalMagnet, terminalType, edgeView, toolView) {
...
SourceAnchor.defaults = Object.assign(Object.assign({}, Anchor.getDefaults()), { name: 'source-anchor', type: 'source' });
class TargetAnchor extends Anchor {
}
exports.TargetAnchor = TargetAnchor;
TargetAnchor.defaults = Object.assign(Object.assign({}, Anchor.getDefaults()), { name: 'target-anchor', type: 'target' });
