export function parseModifierKey(modifiers) {
    const or = [];
    const and = [];
...
export function isModifierKeyEqual(modifiers1, modifiers2) {
...
export function isModifierKeyMatch(e, modifiers, strict) {
    if (modifiers == null ||
