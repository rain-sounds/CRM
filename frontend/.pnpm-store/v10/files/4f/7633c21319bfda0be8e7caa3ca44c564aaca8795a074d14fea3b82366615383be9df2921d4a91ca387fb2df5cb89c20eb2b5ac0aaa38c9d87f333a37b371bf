...
import { attrRegistry, backgroundRegistry, connectionPointRegistry, connectorRegistry, edgeAnchorRegistry, edgeToolRegistry, filterRegistry, gridRegistry, highlighterRegistry, markerRegistry, nodeAnchorRegistry, nodeToolRegistry, portLabelLayoutRegistry, portLayoutRegistry, routerRegistry, } from '../registry';
...
Graph.registerAttr = attrRegistry.register;
Graph.registerGrid = gridRegistry.register;
Graph.registerFilter = filterRegistry.register;
Graph.registerNodeTool = nodeToolRegistry.register;
Graph.registerEdgeTool = edgeToolRegistry.register;
Graph.registerBackground = backgroundRegistry.register;
Graph.registerHighlighter = highlighterRegistry.register;
Graph.registerPortLayout = portLayoutRegistry.register;
Graph.registerPortLabelLayout = portLabelLayoutRegistry.register;
Graph.registerMarker = markerRegistry.register;
Graph.registerRouter = routerRegistry.register;
Graph.registerConnector = connectorRegistry.register;
Graph.registerAnchor = nodeAnchorRegistry.register;
Graph.registerEdgeAnchor = edgeAnchorRegistry.register;
Graph.registerConnectionPoint = connectionPointRegistry.register;
...
Graph.unregisterAttr = attrRegistry.unregister;
Graph.unregisterGrid = gridRegistry.unregister;
Graph.unregisterFilter = filterRegistry.unregister;
Graph.unregisterNodeTool = nodeToolRegistry.unregister;
Graph.unregisterEdgeTool = edgeToolRegistry.unregister;
Graph.unregisterBackground = backgroundRegistry.unregister;
Graph.unregisterHighlighter = highlighterRegistry.unregister;
Graph.unregisterPortLayout = portLayoutRegistry.unregister;
Graph.unregisterPortLabelLayout = portLabelLayoutRegistry.unregister;
Graph.unregisterMarker = markerRegistry.unregister;
Graph.unregisterRouter = routerRegistry.unregister;
Graph.unregisterConnector = connectorRegistry.unregister;
Graph.unregisterAnchor = nodeAnchorRegistry.unregister;
Graph.unregisterEdgeAnchor = edgeAnchorRegistry.unregister;
Graph.unregisterConnectionPoint = connectionPointRegistry.unregister;
__decorate([
    disposable()
