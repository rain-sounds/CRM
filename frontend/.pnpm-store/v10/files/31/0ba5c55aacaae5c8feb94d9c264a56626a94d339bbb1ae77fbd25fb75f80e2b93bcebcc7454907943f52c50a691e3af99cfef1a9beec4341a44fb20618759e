...
import { Basecoat, CssLoader, Dom, disposable, isModifierKeyMatch, } from '../../common';
...
export class Scroller extends Basecoat {
    ...
    init(graph) {
        this.graph = graph;
        const options = getOptions(Object.assign(Object.assign({ enabled: true }, this.options), { graph }));
        this.options = options;
    ...
    allowPanning(e, strict) {
        return (this.pannable && isModifierKeyMatch(e, this.options.modifiers, strict));
    }
