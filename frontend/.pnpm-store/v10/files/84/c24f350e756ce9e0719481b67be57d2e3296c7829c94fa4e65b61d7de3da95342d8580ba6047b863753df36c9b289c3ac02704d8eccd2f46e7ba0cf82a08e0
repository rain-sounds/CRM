...
export class Segments extends ToolItem {
    constructor() {
        super(...arguments);
        this.handles = [];
    }
...
Segments.defaults = Object.assign(Object.assign({}, ToolItem.defaults), { name: 'segments', precision: 0.5, threshold: 40, snapRadius: 10, stopPropagation: true, removeRedundancies: true, attrs: {
        width: 20,
        height: 8,
        x: -10,
        y: -4,
...
class Handle extends View {
    ...
    render() {
        this.container = createViewElement('rect', true);
