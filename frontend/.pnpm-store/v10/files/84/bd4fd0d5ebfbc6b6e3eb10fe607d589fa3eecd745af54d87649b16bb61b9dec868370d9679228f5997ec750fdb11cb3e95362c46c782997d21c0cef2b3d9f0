...
function lum(color, amt) {
    if (typeof color === 'string') {
        ...
        const r = number_1.NumberExt.clamp((num >> 16) + amt, 0, 255);
        const g = number_1.NumberExt.clamp(((num >> 8) & 0x00ff) + amt, 0, 255);
        const b = number_1.NumberExt.clamp((num & 0x0000ff) + amt, 0, 255);
